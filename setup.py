#!/usr/bin/env python3
"""
PTTechAI Setup and Installation Script
...
"""
Example Custom Agent for PTTechAI
...
3. Test Installation:
   - Run: python pttechai.py -i (interactive mode)
   - Run: python pttechai.py -t <target> -m full
...
Example Usage:
  ...
  # Scan target
  python pttechai.py -t 192.168.1.0/24 -m network

  # Web application test
  python pttechai.py -t https://example.com -m web

  # Active Directory test
  python pttechai.py -t domain.local -m ad

For help: python pttechai.py --help
""")
