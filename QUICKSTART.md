# PTTechAI v3 - Quick Start Guide

Get PTTechAI running in under 5 minutes.
...
```bash
git clone https://github.com/your-org/PTTechAI.git
cd PTTechAI
...
> **No Docker?** PTTechAI works without it -- the agent uses HTTP-only testing. Docker adds tool-based scanning (Nuclei, Nmap, etc.).

---

## Step 4: Start PTTechAI
...
**PTTechAI v3** - *AI-Powered Autonomous Penetration Testing Platform*
