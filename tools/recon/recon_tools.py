#!/usr/bin/env python3
"""
PTTechAI Advanced Reconnaissance Module
...
class ScreenshotCapture:
    ...
    def __init__(self, config: Dict = None):
        self.config = config or {}
        self.output_dir = config.get('screenshot_dir', '/opt/PTTechAIv2/results/screenshots')
...
class FullReconRunner:
    ...
    def run(self, target: str, target_type: str = "domain", depth: str = "medium") -> Dict:
        ...
        print(f"\n{'='*70}")
        print("    PTTechAI v2 - ADVANCED RECONNAISSANCE ENGINE")
        print(f"{'='*70}")
        print(f"\n[*] Target: {target}")
