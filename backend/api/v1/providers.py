...
PROVIDER_MODELS = {
    ...
    "bailian": ["kimi-k2.5", "qwen-max", "qwen-plus", "qwen-turbo", "deepseek-r1", "deepseek-v3"],
...
ALLOWED_ENV_KEYS = {
    ...
    "OPENROUTER_API_KEY", "TOGETHER_API_KEY", "FIREWORKS_API_KEY", "BAILIAN_API_KEY",
