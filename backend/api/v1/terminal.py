...
@router.get("/templates", dependencies=[Depends(require_api_permission)])
...
@router.post("/session", dependencies=[Depends(require_api_permission)])
...
@router.get("/sessions", dependencies=[Depends(require_api_permission)])
...
@router.get("/sessions/{session_id}", dependencies=[Depends(require_api_permission)])
async def get_session(session_id: str, current_user: User = Depends(get_current_user)):
    """Return the full session including messages, commands, and exploitation path."""
    return _get_session(session_id)


@router.delete("/sessions/{session_id}", dependencies=[Depends(require_api_permission)])
...
@router.post("/sessions/{session_id}/message", dependencies=[Depends(require_api_permission)])
...
@router.post("/sessions/{session_id}/execute", dependencies=[Depends(require_api_permission)])
...
@router.post("/sessions/{session_id}/exploitation-path", dependencies=[Depends(require_api_permission)])
...
@router.get("/sessions/{session_id}/exploitation-path", dependencies=[Depends(require_api_permission)])
...
@router.post("/sessions/{session_id}/vpn/upload", dependencies=[Depends(require_api_permission)])
...
@router.post("/sessions/{session_id}/vpn/connect", dependencies=[Depends(require_api_permission)])
...
@router.post("/sessions/{session_id}/vpn/disconnect", dependencies=[Depends(require_api_permission)])
...
@router.get("/sessions/{session_id}/vpn-status", dependencies=[Depends(require_api_permission)])
