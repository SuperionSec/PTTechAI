...
async def require_non_service_role_terminal(current_user: User = Depends(get_current_user)) -> User:
    """Block SERVICE role from accessing terminal endpoints"""
...
@router.get("/templates", dependencies=[Depends(require_non_service_role_terminal)])
...
@router.post("/session", dependencies=[Depends(require_non_service_role_terminal)])
...
@router.get("/sessions", dependencies=[Depends(require_non_service_role_terminal)])
...
@router.get("/sessions/{session_id}", dependencies=[Depends(require_non_service_role_terminal)])
async def get_session(session_id: str, current_user: User = Depends(get_current_user)):
    """Return the full session including messages, commands, and exploitation path."""
    return _get_session(session_id)


@router.delete("/sessions/{session_id}", dependencies=[Depends(require_non_service_role_terminal)])
...
@router.post("/sessions/{session_id}/message", dependencies=[Depends(require_non_service_role_terminal)])
async def send_message(session_id: str, req: MessageRequest, current_user: User = Depends(get_current_user)):
...
@router.post("/sessions/{session_id}/execute", dependencies=[Depends(require_non_service_role_terminal)])
async def execute_command(session_id: str, req: ExecuteCommandRequest, current_user: User = Depends(get_current_user)):
...
@router.post("/sessions/{session_id}/exploitation-path", dependencies=[Depends(require_non_service_role_terminal)])
async def add_exploitation_step(session_id: str, req: ExploitationStepRequest, current_user: User = Depends(get_current_user)):
...
@router.get("/sessions/{session_id}/exploitation-path", dependencies=[Depends(require_non_service_role_terminal)])
async def get_exploitation_path(session_id: str, current_user: User = Depends(get_current_user)):
...
@router.post("/sessions/{session_id}/vpn/upload", dependencies=[Depends(require_non_service_role_terminal)])
...
@router.post("/sessions/{session_id}/vpn/connect", dependencies=[Depends(require_non_service_role_terminal)])
async def connect_vpn(session_id: str, current_user: User = Depends(get_current_user)):
...
@router.post("/sessions/{session_id}/vpn/disconnect", dependencies=[Depends(require_non_service_role_terminal)])
async def disconnect_vpn(session_id: str, current_user: User = Depends(get_current_user)):
...
@router.get("/sessions/{session_id}/vpn-status", dependencies=[Depends(require_non_service_role_terminal)])
async def get_vpn_status(session_id: str, current_user: User = Depends(get_current_user)):
