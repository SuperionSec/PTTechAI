...
PTTechAI is a homologated penetration testing tool designed for authorized security assessments.
...
class ScanService:
    ...
    async def execute_scan(self, scan_id: str):
        ...
        try:
            ...
            await ws_manager.broadcast_log(scan_id, "info", "PTTechAI v3 - AI-Powered Penetration Testing")
            await ws_manager.broadcast_log(scan_id, "info", "=" * 60)
...
"""
    ...
    def _build_auth_headers(self, scan: Scan) -> Dict[str, str]:
        ...
        headers = {"User-Agent": "PTTechAI/3.0"}
