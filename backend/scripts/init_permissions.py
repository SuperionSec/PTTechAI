...
PERMISSION_FRONTEND_PAGES = {
    ...
    "settings:manage": ["/settings", "/languages", "/mcp", "/unmapped-resources", "/menus"],
    "user:create": ["/users"],
    "user:read": ["/users", "/profile"],
    "user:update": ["/users"],
    "user:delete": ["/users"],
    "user:manage": ["/users", "/roles", "/unmapped-resources"],
...
PERMISSION_BACKEND_APIS = {
    ...
    "settings:manage": [
        ...
        "GET /api/v1/rbac", "GET /api/v1/rbac/*",
        "POST /api/v1/rbac/*",
        "PUT /api/v1/rbac/*",
        "DELETE /api/v1/rbac/*",
    ...
    "user:create": ["POST /api/v1/users", "POST /api/v1/system/users"],
    "user:read": ["GET /api/v1/users", "GET /api/v1/users/*", "GET /api/v1/auth/me", "GET /api/v1/system/users", "GET /api/v1/system/users/*", "GET /api/v1/system/profile/me"],
    "user:update": ["PUT /api/v1/users/*", "PUT /api/v1/auth/me", "PUT /api/v1/auth/change-password", "PUT /api/v1/system/users/*", "PUT /api/v1/system/profile/me", "PUT /api/v1/system/profile/change-password"],
    "user:delete": ["DELETE /api/v1/users/*", "DELETE /api/v1/system/users/*"],
    "user:manage": ["POST /api/v1/users/*/reset-password", "POST /api/v1/system/users/*/reset-password"],
