...
PERMISSION_BACKEND_APIS = {
    ...
    "user:read": ["GET /api/v1/users", "GET /api/v1/users/*", "GET /api/v1/auth/me"],
    "user:update": ["PUT /api/v1/users/*", "PUT /api/v1/auth/me", "PUT /api/v1/auth/change-password"],
    "user:delete": ["DELETE /api/v1/users/*"],
    "user:manage": ["POST /api/v1/users/*/reset-password"],
