...
```bash
docker build -f docker/Dockerfile.kali -t PTTechAI-kali:latest docker/
```
...
- CLI report (`PTTechAI.py`) does not embed screenshots (backend reports do)
